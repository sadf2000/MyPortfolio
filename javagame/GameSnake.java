...
public class GameSnake {
    //game constants
    final String TITLE_OF_PROGRAM = "Круглая Змейка :0 ";
    final String GAME_OVER_MSG = "Побробуй еще раз, перезапустив код java GameSnake.java";
